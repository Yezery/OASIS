...
function startSpinning(options) {
  if (!options) options = defaultOptions;else options = Object.assign({}, defaultOptions, options);
...
index_1.startSpinning({
  duration: 3000,
  spinner: ["○", "⦿", "◉", "●"]
});
},{"../index":"../index.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
